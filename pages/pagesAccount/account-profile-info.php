  ...
  <div id="containAccount" class="container">
    ...
    <div id="containerBreadcrumbs">
      <div class="breadcrumbs">
        ...
        <a class="active" href="account.php" class="active">Mi cuenta</a>
        <i class="bi bi-chevron-right"></i>
        <a href="account-profile-info.php">Perfil</a>
      </div>
    </div>
      ...
      <aside id="sidebar">
        ...
        <nav>
          <div>
            ...
            <a href="account-profile-info.php" class="active">Información del perfil</a>
          ...
          <form id="profileInfo-Form" action="" method="POST">
            <div class="form-row">
              <div class="form-field">
                ...
                <input type="text" id="nombre" name="nombre" class="inputAccount" required>
              </div>

              <div class="form-field">
                <label for="apellidos">Apellido <span style="color:#fd3d57;">*</span></label>
                <input type="text" id="apellidos" name="apellidos" class="inputAccount" required>
              </div>

              <div class="form-field">
                <label for="telefono">Número de teléfono <span style="color:#fd3d57;">*</span></label>
                <input type="number" id="telefono" name="telefono" class="inputAccount" required>
              </div>
            </div>
