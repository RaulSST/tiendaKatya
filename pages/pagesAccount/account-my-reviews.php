...
<body>
  ...
  <div id="containAccount" class="container">
    ...
    <div id="containerAccount">
      ...
      <aside id="sidebar">
        ...
        <nav>
          ...
          <div>
            ...
            <a href="account-my-reviews.php" class="active">Mis reseñas</a>
          </div>
      ...
      <main id="main">
        <div class="profile-section" style="flex-direction: column;">
          <h2>Mis reseñas</h2>

          <?php
          // Asegúrate de que $result tiene resultados antes de intentar leerlos
          if (isset($result) && mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
              // Genera el enlace para escribir/editar reseña.
              // Necesitarás el ID del producto y el ID de la orden para la página review.php
              $reviewLink = "../pagesProductos/product.php?id=" . htmlspecialchars($row['producto_id']);
          ?>

              <div class="order-card" id="orderCardReviews">
                <div class="order-info">
                  ...
                  <div class="order-details">
                    ...
                    <div>
                      ...
                      <p><?php echo htmlspecialchars($row['orden_id']); ?></p>
                    </div>

                    <div>
                      <p><strong>Comprado:</strong></p>
                      <p><?php echo htmlspecialchars(date("d/m/Y", strtotime($row['fecha_orden']))); ?></p>
                    </div>

                    <div style="display: flex; align-items: center;">
                      <a style="text-decoration: none" href="<?php echo $reviewLink; ?>" class="btnPedido">Escribir reseña</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <?php
            ...
            // Mensaje si no hay productos comprados o no se encontraron resultados
            echo '<p>No has realizado compras o no tienes productos que puedan ser reseñados.</p>';
          }
          ?>
        </div>
      </main>
