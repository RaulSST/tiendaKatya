...
<body>
  ...
  <div id="containFaq" class="container">
    ...
    <div id="divContainFAQ">

      <h2>Preguntas Frecuentes</h2>
      <p>¡Compartimos algunas de las preguntas más frecuentes para ayudarte!</p>
      ...
      <div class="accordion">
        ...
        <div class="accordion-item">
          <div class="accordion-header">
            ¿Cómo se entregará mi paquete?
            <span class="accordion-icon">+</span>
          </div>
          <div class="accordion-content">
            El paquete será entregado directamente por el propietario de la tienda,
            asegurando un servicio personalizado y confiable.
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            El tiempo estimado de entrega es de 1 a 2 días hábiles,
            dependiendo de la ubicación del destinatario.
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            Puedes realizar el seguimiento de tu pedido a través del historial de pedidos
            en nuestra página. Simplemente ingresa a tu cuenta y accede a la sección de
            "Historial de pedidos > Rastreo de Pedido" para ver el estado de tu envío en tiempo real.
          </div>
        </div>
      ...
      <div class="accordion">
        ...
        <div class="accordion-item">
          <div class="accordion-header">
            ¿Que tipos de pago puedo usar?
            <span class="accordion-icon">+</span>
          </div>
          <div class="accordion-content">
            Puedes realizar el pago de tu pedido mediante tarjeta de crédito o débito,
            incluyendo tarjetas de Visa, Mastercard, American Express, entre otras. Además,
            ofrecemos la opción de pago en efectivo contra entrega, para tu mayor comodidad.
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            No, el costo del envío no es cobrado al cliente. El envío es completamente gratuito para todos nuestros
            pedidos.
          </div>
        </div>
      </div>
